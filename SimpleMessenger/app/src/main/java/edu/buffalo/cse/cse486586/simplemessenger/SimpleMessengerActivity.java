        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            while(true) {
                try {
                    ...
                    Log.e(TAG, "server : socket accept created");
                    InputStream inStream = serverListener.getInputStream();
                    Log.e(TAG, "server : input stream created");
                    BufferedReader in = new BufferedReader(new InputStreamReader(inStream));
                    Log.e(TAG, "server : Message about to read");
                    String message = in.readLine();
                    Log.e(TAG, "server : Message read - " + message);
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                Log.e(TAG, "client : Message to send - " + msgToSend);

                // TODO: Fill in your client code that sends out a message.

                OutputStream outStream = socket.getOutputStream();
                Log.i(TAG, "client : socket output stream created");
                PrintWriter out = new PrintWriter(new BufferedWriter(new OutputStreamWriter(outStream)));
                Log.i(TAG, "client : Message about to send");
